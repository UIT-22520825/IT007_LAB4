...
int main(){
    ...
    priority_queue<Process, vector<Process>, burst_priority> queue_process;
    ...
    while(remain_process !=0 || !queue_process.empty()){
        ...
        queue_process.pop();
        current_p.rp_time= time_start - current_p.arr_time;
        current_p.finish_time= time_start+ current_p.burst_time;
        ...
        time_start= current_p.finish_time;
